...
import apriliaSr1 from "@/assets/fleet/aprilia-sr125-1.jpg";
import apriliaSr2 from "@/assets/fleet/aprilia-sr125-2.jpg";
import liberty1 from "@/assets/fleet/piaggio-liberty125-1.jpg";
import liberty2 from "@/assets/fleet/piaggio-liberty125-2.jpg";
import pcx1 from "@/assets/fleet/honda-pcx125-1.jpg";
import pcx2 from "@/assets/fleet/honda-pcx125-2.jpg";
...
export const fleet: Vehicle[] = [
  ...
  // ============ SCUTERE 125CC ============
  {
    ...
    pricePerMonth: 1100,
    availability: "disponibil",
    shortDescription: "Scuter sport italian 125cc cu motor monocilindru 4T, injectie EFI si transmisie CVT. Manevrabilitate excelenta in trafic urban.",
    highlights: [
      "Motor 125cc 4T, racire cu aer",
      "Putere ~10-11 CP, cuplu ~10 Nm",
      "Injectie electronica EFI",
      "Viteza maxima ~90-95 km/h",
      "Consum 2.3-2.6 L/100 km",
      "Frana disc fata, suspensie confortabila",
      "Design sportiv specific Aprilia",
    ],
    included: COMMON_INCLUDED_SCOOTER,
    rules: ["Permis A1/B", "Garantie 1000 lei"],
    images: [apriliaSr1, apriliaSr2],
  },
  {
    ...
    pricePerMonth: 1100,
    availability: "disponibil",
    shortDescription: "Scuter italian premium 124cc cu motor i-get 4T si roti mari de 16\". Stabilitate ridicata si confort pentru utilizare zilnica.",
    highlights: [
      "Motor 124cc i-get, 4T, racire pe aer",
      "Putere 11 CP / 8.1 kW, cuplu ~11 Nm",
      "Transmisie automata CVT",
      "Frana fata disc ABS 240 mm",
      "Roti 16\" fata / 14\" spate",
      "Consum ~2.5 L/100 km",
      "Design italian premium",
    ],
    included: COMMON_INCLUDED_SCOOTER,
    rules: ["Permis A1/B", "Garantie 1000 lei"],
    images: [liberty1, liberty2],
  },
  {
    id: "honda-pcx-125",
    slug: "honda-pcx-125",
    ...
    pricePerMonth: 1280,
    availability: "disponibil",
    shortDescription: "Scuter premium 125cc cu motor eSP+ racit cu lichid, sistem Start-Stop si ABS. Cel mai economic si confortabil din clasa sa.",
    highlights: [
      "Motor 125cc eSP+, 4T, SOHC, racire cu lichid",
      "Putere 12.5 CP / 9.2 kW, cuplu 11.7 Nm",
      "Sistem Start-Stop",
      "Consum ~2.1 L/100 km, autonomie ~385 km",
      "Rezervor 8.1 litri, greutate ~134 kg",
      "Frane ABS fata, discuri fata/spate",
      "Spatiu mare de depozitare sub sa",
    ],
    included: COMMON_INCLUDED_SCOOTER,
