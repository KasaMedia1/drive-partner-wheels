...
const sections: Section[] = [
  ...
  },
  {
    ...
    Icon: KeyRound,
    intro: "Mopede 50cc accesibile cu categoria AM, varsta minima 16 ani. Solutia ideala pentru cei care nu au inca permis A1.",
  ...
  },
  {
    ...
    Icon: Zap,
    intro: "Mobilitate moderna, silentioasa, fara costuri de combustibil. Bateriile detasabile permit incarcare comoda acasa sau la sediu.",
    audience: "Recomandat pentru: livrari urbane scurte si medii, cu costuri minime de operare si zero emisii.",
    filter: (v) => v.category === "scuter" && v.scooterClass === "electric",
  },
  {
    id: "biciclete",
    title: "Biciclete electrice",
    Icon: Bike,
    intro: "Alternativa eficienta si accesibila pentru mediul urban. Fara permis, fara taxe de combustibil, perfecte pentru zone aglomerate.",
    audience: "Recomandat pentru: livrari in centrul orasului, deplasari pe distante scurte si medii, curieri Glovo si Wolt.",
  ...
  },
  {
    ...
    Icon: Car,
    intro: "Masini cu consum redus si costuri mici de intretinere, gandite pentru activitate constanta si confort pe termen lung.",
